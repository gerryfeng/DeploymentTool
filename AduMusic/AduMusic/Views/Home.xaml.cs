    ...
    public partial class Home : Page
    {
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                iisData.ItemsSource = list;
                wulianData.ItemsSource = list;
                pandaGisData.ItemsSource = list;
                GeoServerData.ItemsSource = list;
            }
        ...
        {
            NavigationService.GetNavigationService(this).Navigate(new Uri("/Views/MusicList.xaml", UriKind.Relative));
        }
